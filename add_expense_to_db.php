...
if ($unique_id == 0) {
    try {
        ...
        $insert_exp_into_db_q = mysqli_query($con, "insert into monthly_expense (Date, TitleOfExpense, Cost, Category) values('$exp_date', '$exp_title', $cost, '$exp_category');");
    ...
    try {
        ...
        $update_exp_log_q = mysqli_query($con, "update monthly_expense set Date = '$exp_date', TitleOfExpense = '$exp_title', Cost = $cost, Category = '$exp_category' where SNo = $unique_id;");
